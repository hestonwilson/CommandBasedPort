...
double inputRange = INT_MAX; //std::numeric_limits<double>::infinity(); 
double minOutput = -INT_MAX; //-std::numeric_limits<double>::infinity();
double maxOutput =  INT_MAX; //std::numeric_limits<double>::infinity();
double lastError = NAN;
double integralAccumulation = 0.0;
double integralRange = INT_MAX; //std::numeric_limits<double>::infinity();
